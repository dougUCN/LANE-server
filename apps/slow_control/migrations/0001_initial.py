# Generated by Django 3.2.12 on 2022-11-30 10:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('RunConfig', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='steps', to='slow_control.runconfig')),
            ],
            options={
                'ordering': ['time'],
            },
