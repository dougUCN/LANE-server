...
@query.field("getRuns")
async def resolve_runs(*_, names=None, minStartDate=None, maxStartDate=None, minSubDate=None, maxSubDate=None, status=None):
    return await _filter_runs(names, minStartDate, maxStartDate, minSubDate, maxSubDate, status)
